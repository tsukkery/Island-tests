...
public class AnimalLifecycleTask implements Runnable {
    ...
    public void run() {
        ...
        executorService.submit(animalEatTask); //ест
        executorService.submit(animalMultiplyTask); //размножается
        ...
        executorService.submit(new AnimalMoveTask()); // животные передвигаются
    }
